...
This was the app I submitted for AP Computer Science Principles in 2020.

The snake image is fully functional on the display of the app, but for whatever reason that's the only image that gets corrupted in this format here.
